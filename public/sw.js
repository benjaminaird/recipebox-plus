 ...
 */
const VERSION = '2026-06-26t';
const SHELL_CACHE = 'rb-shell-' + VERSION;
const RUNTIME_CACHE = 'rb-runtime-' + VERSION;

const PRECACHE = [
  '/', '/index.html', '/app.js', '/shopping-list.js', '/recipe-tags.js', '/nutrition.js', '/recipe-extract.js', '/recipe-grounding.js', '/recipe-schema.js', '/app-config.js',
